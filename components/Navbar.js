...
const Navbar = () => {
  return (
    <nav className="flex items-center justify-between py-4 px-4 lg:px-32 md:py-8 md:px-16 bg-[#FFF9F7] relative w-full">
      {/* Left: Logo */}
      ...
      <div className="flex-1 flex justify-end items-center space-x-4 md:space-x-6 lg:space-x-8">
        ...
        <a href="#" className="text-gray-700 font-light text-base md:text-lg hover:text-orange-500 transition-colors">Login</a>
